...
In Noble we switched from resolved to systemd-resolve, with this change and to be backwards compatible with our bosh-dns release. some configuration are neccary in the runtime config for DNS
